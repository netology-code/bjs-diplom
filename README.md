...
7. В случае удачного добавления денег на счёт вызовите метод конвертации денег из текущей валюты в **Нетокоины**. Обратите внимание, что для корректной авторизации вам потребуется получить данные из функции получения курса валют.
